...
public final class AplicatieBancara {
    ...
    public static final class Client implements Comparable<Client> {
        ...
        public Card creeazaCard(ContBancar contBancar, String numarCard, String cvv, LocalDate dataExpirare) {
            if (contBancar.getProprietar() == this) {
                return Card.creeazaCard(this, contBancar, new StringBuilder(numarCard), new StringBuilder(cvv), dataExpirare);
            } else {
                System.out.println("*** Acest client nu este proprietarul contului ***");
                return null;
            }
    ...
    public final static class Card {
        ...
        private Card(ContBancar contBancar, StringBuilder numarCard, StringBuilder cvv, LocalDate dataExpirare) {
            this.contBancar = contBancar;
        ...
        static Card creeazaCard(Client client, ContBancar contBancar, StringBuilder numarCard, StringBuilder cvv, LocalDate dataExpirare){
            if(contBancar.getProprietar() == client){
                return new Card(contBancar, numarCard, cvv, dataExpirare);
            }
            System.out.println("*** Acest client nu este proprietarul contului. Operatia creeazaCard a returnat null ***");
            return null;
        }
